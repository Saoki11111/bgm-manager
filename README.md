...
6. `おまかせループ`で1曲を自動選択するか、`曲を選ぶ`から曲を選ぶと再生します。
...
`おまかせループ`を選ぶと、曲リストから1曲だけランダムに選び、その曲をループ再生します。
`再生時間`で1時間、2時間、3時間を選ぶと、タイマー終了までリピート再生します。
...
`おまかせループ`でも次の曲には進まず、選ばれた1曲だけを繰り返します。
